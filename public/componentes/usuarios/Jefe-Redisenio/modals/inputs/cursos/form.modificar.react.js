...
export default class Input_Modificar extends React.Component {
    ...
    render() {
        ...
        const nombre = [data[0], 'input-field col s12 m12 l12', 'Nombre del Curso', 'validate active', '30'];
        const area = [data[1], 'input-field col s12 m12 l12', 'Área', 'validate active', '30'];
        const destreza = [data[2], 'input-field col s12 m12 l12', 'Destrezas', 'validate active', '50'];
