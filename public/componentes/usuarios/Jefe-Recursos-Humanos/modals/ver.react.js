			...
			<div>
				...
				<div id={name_div} className="modal modal-fixed-footer">
					<div className="modal-content">
						<h4 className='center hide-on-small-only'><b>Aprobar {title}</b></h4>
						<h5 className='center hide-on-med-and-up'><b>Aprobar {title}</b></h5>
						<br />
						 <div className='center'>
							 {/*este boton muestra un pdf en otra pestaña*/}
							<a className="btn-large waves-effect waves-light green darken-4" target="_blank">
