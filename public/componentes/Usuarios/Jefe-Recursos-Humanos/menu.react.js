			...
			<div className="row">
				<div className="col s12 green darken-4">
					<ul className="tabs green darken-4">
						...
						<li className="tab"><a href="#contratos">Contratos</a></li>
						<li className="tab"><a href="#detalle_curso">Aprobar Cursos</a></li>
						<li className="tab"><a href="#docente">Docentes</a></li>
					</ul>
				</div>
